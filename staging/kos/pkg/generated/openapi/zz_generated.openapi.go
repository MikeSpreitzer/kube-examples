...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.IPLockList":              schema_pkg_apis_network_v1alpha1_IPLockList(ref),
		"k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.IPLockSpec":              schema_pkg_apis_network_v1alpha1_IPLockSpec(ref),
		"k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.NetworkAttachment":       schema_pkg_apis_network_v1alpha1_NetworkAttachment(ref),
		"k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.NetworkAttachmentErrors": schema_pkg_apis_network_v1alpha1_NetworkAttachmentErrors(ref),
		"k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.NetworkAttachmentList":   schema_pkg_apis_network_v1alpha1_NetworkAttachmentList(ref),
		"k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.NetworkAttachmentSpec":   schema_pkg_apis_network_v1alpha1_NetworkAttachmentSpec(ref),
		"k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.NetworkAttachmentStatus": schema_pkg_apis_network_v1alpha1_NetworkAttachmentStatus(ref),
		"k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.ObjectWrite":             schema_pkg_apis_network_v1alpha1_ObjectWrite(ref),
		"k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.Subnet":                  schema_pkg_apis_network_v1alpha1_Subnet(ref),
...
func schema_pkg_apis_network_v1alpha1_ExecReport(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ExecReport reports on what happened when a command was execd.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"command": {
						VendorExtensible: spec.VendorExtensible{
						...
						SchemaProps: spec.SchemaProps{
							Description: "Command is the command whose execution is summarized by this ExecReport.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"exitStatus": {
						SchemaProps: spec.SchemaProps{
							Description: "ExitStatus is the Linux exit status from the command, or a negative number to signal a prior problem (detailed in StdErr).",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
...
func schema_pkg_apis_network_v1alpha1_ExtendedObjectMeta(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ExtendedObjectMeta has extra metadata for an API object. This is maintained by the server, clients can not modify it.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"writes": {
						VendorExtensible: spec.VendorExtensible{
							Extensions: spec.Extensions{
								"x-kubernetes-list-map-keys": "section",
								"x-kubernetes-list-type":     "map",
							},
						},
						SchemaProps: spec.SchemaProps{
							Description: "Writes identifies the latest write to each part of the object.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.ObjectWrite"),
									},
								},
							},
						},
...
func schema_pkg_apis_network_v1alpha1_IPLock(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_network_v1alpha1_IPLockList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "IPLockList is a list of IPLock objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.IPLock"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.IPLock"},
	}
}

func schema_pkg_apis_network_v1alpha1_IPLockSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_network_v1alpha1_NetworkAttachment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NetworkAttachment is about a Linux network interface connected to a Subnet.  The sections recorded in ExtendedObjectMeta are: spec, status.address, status.impl, status.execReport.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.NetworkAttachmentSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.NetworkAttachmentStatus"),
						},
					},
				},
				Required: []string{"spec"},
...
func schema_pkg_apis_network_v1alpha1_NetworkAttachmentErrors(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"ipam": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "IPAM holds errors about the IP Address Management for this attachment.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"host": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Host holds errors from the node where this attachment is placed.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_network_v1alpha1_NetworkAttachmentList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NetworkAttachmentList is a list of NetworkAttachment objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.NetworkAttachment"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.NetworkAttachment"},
	}
}

func schema_pkg_apis_network_v1alpha1_NetworkAttachmentSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"postCreateExec": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "PostCreateExec is a command to exec inside the attachment host's connection agent container after a new Linux network interface for the attachment is created with a network fabric operation. By definition, it is not guaranteed to execute; if the Linux network interface for the attachment previously belonged to another attachment and was recycled as opposed to being created, PostCreateExec will not execute. After PostCreateExec has executed the results of the execution are reported through the NetworkAttachmentStatus PostCreateExecReport field. The connection agent is configured with a set of allowed programs to invoke. If a non-allowed program is requested then the result will report an error.  Each argument is subjected to a very restricted form of variable expansion.  The only allowed syntax is `${variableName}` and the only variables are `ifname`, `ipv4`, and `mac`. PostCreateExec is immutable: attempts to update it will fail.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"postDeleteExec": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "PostDeleteExec is a command to exec inside the attachment host's connection agent container after the attachment's Linux network interface is deleted.  Precisely: if a local NetworkAttachment is not in the network fabric, has a PostCreateExec that has been started, has a non-empty PostDeleteExec, and the PostCreateExec has not yet been launched then that command will be launched.  The result is not reported in the status of the NetworkAttachment (it may be deleted by then).  The same restrictions and variable expansions as for PostCreateExec are applied.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_network_v1alpha1_NetworkAttachmentStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"addressVNI": {
						SchemaProps: spec.SchemaProps{
							Description: "AddressVNI is the VNI associated with this attachment's IP address assignment, or the empty string when there is no address.",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
					"ipv4": {
						SchemaProps: spec.SchemaProps{
							Description: "IPv4 is non-empty when an address has been assigned.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"macAddress": {
						SchemaProps: spec.SchemaProps{
							Description: "MACAddress is non-empty while there is a corresponding Linux network interface on the host.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"ifcName": {
						SchemaProps: spec.SchemaProps{
							Description: "IfcName is the name of the network interface that implements this attachment on its node, or the empty string to indicate no implementation.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"hostIP": {
						SchemaProps: spec.SchemaProps{
							Description: "HostIP is the IP address of the node the attachment is bound to.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"postCreateExecReport": {
						SchemaProps: spec.SchemaProps{
							Description: "PostCreateExecReport, if non-nil, reports on the run of the PostCreateExec that was launched when the Linux network interface owned by the attachment was created. Notice that such PostCreateExec might differ from the one in the NetworkAttachmentSpec PostCreateExec field of the attachment; precisely, if the Linux network interface for the attachment was recycled as opposed to being created with a network fabric operation, PostCreateExecReport reports on the run of the PostCreateExec of the attachment for whom the Linux network interface was first created.",
...
func schema_pkg_apis_network_v1alpha1_ObjectWrite(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ObjectWrite describes a write to part of an object",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"section": {
						SchemaProps: spec.SchemaProps{
							Description: "Section identifies the part of the object that was written. Each type of object is broken down into a type-specific set of sections.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
				...
				Required: []string{"section", "serverTime"},
			},
		},
		Dependencies: []string{
...
func schema_pkg_apis_network_v1alpha1_Subnet(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Subnet is about an IP subnet on a virtual network.  For ExtendedObjectMeta the sections are: spec, status.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.SubnetSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.SubnetStatus"),
						},
					},
				},
				Required: []string{"spec"},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.ExtendedObjectMeta", "k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.SubnetSpec", "k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.SubnetStatus"},
	}
}
...
func schema_pkg_apis_network_v1alpha1_SubnetList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.Subnet"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.Subnet"},
	}
}
...
func schema_pkg_apis_network_v1alpha1_SubnetSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SubnetSpec is the desired state of a subnet. For a given VNI, all the subnets having that VNI: - have disjoint IP ranges, and - are in the same Kubernetes API namespace.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"ipv4": {
						SchemaProps: spec.SchemaProps{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"errors": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Errors holds the complaints, if any, from the subnet validator. It is non-empty if and only if Validated is false for reasons (2) or (3).",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
